...
Target.create "Lib_Build" (fun _ ->
  buildSource "Be.Vlaanderen.Basisregisters.Api"
  buildTest "Be.Vlaanderen.Basisregisters.Api.Tests"
  buildTest "Dummy.Api"
)
...
Target.create "Lib_Publish" (fun _ -> publishSource "Be.Vlaanderen.Basisregisters.Api")
Target.create "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.Api")
// --------------------------------------------------------------------------------
