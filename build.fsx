...
Target "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.Api")
Target "Lib_Test" (fun _ -> [ "test" @@ "Be.Vlaanderen.Basisregisters.Api.Tests" ] |> List.iter testWithDotNet)

Target "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.Api")
Target "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.Api")
